...
<head>
    ...
    <style>
        ...
        .page{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;background:
            radial-gradient(circle at 20% 20%, rgba(255,95,115,.09), transparent 25%),
        ...
        .left{padding:42px}
        .code{font-size:140px;font-weight:900;line-height:.9;color:#ff8c9a}
        ...
        .btn-primary{background:#ff5f73;color:#fff}
        .btn-secondary{background:rgba(255,255,255,.05);color:#fff;border:1px solid rgba(255,255,255,.08)}
        .scene{min-height:620px;position:relative;background:radial-gradient(circle at center, rgba(255,95,115,.08), transparent 35%)}
        .monitor{position:absolute;left:50%;top:120px;transform:translateX(-50%);width:280px;height:220px;border-radius:28px;background:#10231c;border:1px solid rgba(255,95,115,.25);display:flex;align-items:center;justify-content:center;flex-direction:column}
        .monitor .n{font-size:74px;font-weight:900;color:#ff8c9a}
...
<div class="page">
    <div class="box">
        <section class="card left">
            ...
            <div class="desc">
                O sistema encontrou a página, mas esta área está protegida.
                O gato enfermeiro até tentou entrar com o cabo de rede,
                mas o cachorro enfermeiro foi barrado pela segurança digital.
            </div>
        ...
        <section class="card scene">
            <div class="bubble b1">
                ...
                <small>Gato enfermeiro em modo segurança.</small>
            </div>

            <div class="bubble b2">
                <strong>Mas eu só queria entrar...</strong>
                <small>Cachorro enfermeiro sem permissão.</small>
            </div>

            <div class="monitor">
                <div class="n">403</div>
                <div class="t">Permissão insuficiente</div>
            </div>
            ...
            <div class="subtitle">
                <strong>Episódio 403 — porta bloqueada</strong>
                <span>Seu perfil não tem autorização para acessar esta área do sistema.</span>
            </div>
        </section>
    </div>
</div>
