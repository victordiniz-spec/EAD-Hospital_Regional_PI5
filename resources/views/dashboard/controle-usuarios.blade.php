    ...
    <main class="flex-1 p-4 pt-20 sm:p-6 lg:p-8 lg:pt-8 bg-[#0B1120] text-white overflow-x-hidden">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="relative w-full sm:w-80">
                    ...
                    <input
                        ...
                        class="w-full bg-[#1E293B] border border-slate-700 text-white placeholder-gray-500 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    >
                </div>
                ...
                <button type="button"
                        ...
                        class="bg-[#1E293B] border border-slate-700 px-4 py-3 rounded-xl hover:bg-slate-700 transition flex items-center justify-center gap-2 text-sm">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-[#1E293B] border border-slate-700 rounded-2xl p-5">
                ...
                <h3 class="text-2xl font-bold mt-1">{{ $usuarios->count() }}</h3>
            </div>
            ...
            <div class="bg-[#1E293B] border border-slate-700 rounded-2xl p-5">
                ...
                <h3 class="text-2xl font-bold mt-1 text-yellow-400">
                    {{ $usuarios->where('status', '!=', 'aprovado')->count() }}
                </h3>
            </div>
        ...
        <!-- CARDS MOBILE -->
        <div class="lg:hidden space-y-4" id="listaUsuariosMobile">

            @foreach($usuarios as $user)
                <div class="usuario-item bg-[#1E293B] border border-slate-700 rounded-2xl p-5 shadow"
                    ...
                    <div class="mt-4 flex gap-2">
                        ...
                        <button
                            ...
                            class="flex-1 bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-xl transition text-sm font-semibold flex items-center justify-center gap-2">
        ...
        <!-- TABELA DESKTOP -->
        <div class="hidden lg:block bg-[#1E293B] rounded-2xl p-6 shadow-md border border-slate-700 overflow-hidden">
                    ...
                    <tbody>
                        ...
                        @foreach($usuarios as $user)
                            <tr class="usuario-item border-b border-gray-800 hover:bg-[#0F172A] transition"
                                ...
                                <!-- EMAIL -->
                                <td class="text-gray-300 break-words">
                                    {{ $user->email }}
                                </td>
