...
<style>
    ...
    */
    ...
    #sidebarProfessor[data-collapsed="true"] .sidebar-icon {
        width: 100% !important;
    ...
    #sidebarProfessor[data-collapsed="true"] .sidebar-icon svg {
    ...
    #sidebarProfessor[data-collapsed="true"] nav > div > .space-y-2 {
        display: flex !important;
        flex-direction: column !important;
        align-items: center !important;
    }

    #sidebarProfessor[data-collapsed="true"] .sidebar-cascade {
        width: 100% !important;
        display: flex !important;
        justify-content: center !important;
    }
    ...
    #sidebarProfessor[data-collapsed="true"] > div:first-child > .flex.items-center.gap-3.mb-8 {
        justify-content: center !important;
    ...
    #sidebarProfessor[data-collapsed="true"] .hidden.lg\:flex.mb-5 {
        justify-content: center !important;
    }

    #sidebarProfessor[data-collapsed="true"] .hidden.lg\:flex.mb-5 button {
        width: 3.75rem !important;
        height: 3.75rem !important;
        min-width: 3.75rem !important;
        min-height: 3.75rem !important;
